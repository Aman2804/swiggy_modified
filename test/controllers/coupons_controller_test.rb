...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { condition: @coupon.condition, coupon_name: @coupon.coupon_name, per_off: @coupon.per_off, type_of_coupon: @coupon.type_of_coupon } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { condition: @coupon.condition, coupon_name: @coupon.coupon_name, per_off: @coupon.per_off, type_of_coupon: @coupon.type_of_coupon } }
